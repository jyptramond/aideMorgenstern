...
const spells = [
    {
      name: "Abondance providentielle de Tegmine",
      difficulty: 20,
      formula: "Généreuse est la terre, pour celui qui a faim, Qui connaît ses mystères, et veille à ses jardins",
      type: ["Terre"],
    ...
    },
    {
      ...
      difficulty: 10,
      formula: "Les Hommes ont-ils vendu tous leurs premiers instincts ? L’ouïe, le flair et la vue, pour ne plus avoir faim ?",
    ...
    },
    {
      ...
      alt: "aigle ouragan",
      difficulty: -30,
      formula: "Ses grandes ailes déployées, sont comme de noirs nuages, Ses serres sont des épées, son cri est un orage",
      type: ["Air"],
      special: "Rituel",
      duration: "RU heures",
      range: "extrême",
      resistance: "-",
      success: "Dégâts +1",
      description: "Vous invoquez l’Aigle-Ouragan, un rapace de 18 mètres d’envergure dont les cris sont terrifiants. Vous pouvez le monter avec vos compagnons et lui ordonner de combattre. Vous ne pouvez l’invoquer plus d’une fois par semaine."
    },
    {
      name: "Ailes de l’archange",
      alt: "ailes de l'archange",
      difficulty: -10,
      formula: "Pour rejoindre les cieux, j’ai déployé mes ailes, Et que mon vol gracieux, glorifie l’Éternel",
      type: ["Protection"],
      duration: "RU heures",
      range: "contact",
      resistance: "-",
    ...
    },
    {
      ...
      alt: "ames infideles",
      difficulty: -10,
      formula: "Par malheur ma famille n’a le rang qui me sied, J’ai troqué mes guenilles, pour vos habits princiers",
      type: ["Mentalisme"],
      duration: "RU heures",
      range: "courte",
      resistance: "VOL-10",
    ...
    },
    {
      ...
      difficulty: -10,
      formula: "Deux mortels désignés, s’aimeront désormais, D’un désir exalté, à défaut d’être vrai",
    ...
    },
    {
      name: "Ange gardien",
      difficulty: 10,
      formula: "Garde-moi du danger, des démons et leur horde, Tu sais me protéger, ange de miséricorde",
      type: ["Protection"],
      duration: "RU minutes",
      range: "moyenne",
      resistance: "-",
    ...
    },
    {
      ...
      difficulty: 0,
      formula: "Bois cette eau que je donne, bois d’un trait ce calice, Que ton corps abandonne, poisons et vénéfices",
    ...
    },
    {
      ...
      alt: "apercu du futur",
      difficulty: 0,
      formula: "J’ai lu entre les lignes des volontés célestes, L’avenir et ses signes, bienveillants ou funestes",
      type: ["Divination"],
    ...
    },
    {
      ...
      alt: "arme de lumiere",
      difficulty: 0,
      formula: "Ce présent dont on doit se servir dignement, Est une arme de foi, de lumière et d’argent",
    ...
    },
    {
      ...
      difficulty: 10,
      formula: "Il se joue des armures, invincible est ce fer, Qu’il abatte les murs, qui se brisent comme du verre",
      type: ["Enchantements"],
      duration: "RU minutes",
      range: "moyenne",
      resistance: "-",
    ...
    },
    {
      ...
      difficulty: -10,
      formula: "Une légion derrière moi, aux armes étincelantes, Hurle, chante et festoie sa victoire écrasante",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Pour affronter le Mal, j’ai endossé l’armure Forgée dans le métal qui arme les coeurs purs",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Que la douce lumière, aussi pure qu’un cristal Renvoie à la poussière les serviteurs du mal",
        type: ["Protection", "Châtiment"],
        duration: "instantanée",
        range: "courte",
        resistance: "VOL",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Que justice soit rendue, il fallait te l’ôter Je recouvre mon dû, et reprends ta beauté",
        type: ["Alchimie"],
        special: "Rituel",
        duration: "RU jours",
        range: "moyenne",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Bois le secret des nymphes pour guérir tes humeurs Le sang, la bile, la lymphe, s’uniront en douceur",
        type: ["Alchimie"],
        special: "Rituel",
        duration: "RU jours",
        range: "contact",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Perdus dans le brouillard, on n’y voit à deux pas, Ni sourire, ni poignard, seules les ombres sont là",
        type: ["Eau", "Ombre"],
        duration: "*MAG* heures",
        range: "longue",
        resistance: "-",
      ...
      },
      {
        name: "Cautérisation",
        difficulty: 0,
        formula: "Sur les braises qu’on rallume, de l’ultime ordalie Que mes plaies se consument, en des sillons brunis",
        type: ["Feu"],
        duration: "instantanée",
        range: "contact",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 20,
        formula: "Ce halo dans la nuit, il m’appelle et m’attire, Tel un phare qui luit, pour guider les navires",
      ...
      },
      {
        name: "Clairvoyance",
        difficulty: 0,
        formula: "J’ai pris de la hauteur, dans le ciel, sous sa voûte, Je suis le spectateur qui t’observe et t’écoute",
        type: ["Divination"],
        duration: "RU minutes",
        range: "spécial",
        resistance: "-",
        success: "le sort est si discret que la cible n’a aucune chance de se sentir observée.",
        description: "Vous espionnez à distance une cible que vous avez déjà vue ou dont vous possédez un objet personnel, où qu’elle soit. De deux choses l’une : votre esprit peut rejoindre directement une cible pour l’espionner. Vous pouvez vous déplacer autour d’elle et inspecter son environnement, mais un premier rôle peut ressentir qu’il est observé s’il réussit un test de VOL ou MAG (au choix du MJ) ou vous pouvez projeter une image « aérienne » de votre cible sur un bassin ou un cristal, pour l’observer en toute sécurité et en faire profiter vos comparses."
      },
      {
        name: "Clef absolue",
        difficulty: 10,
        formula: "Prends une clef de la sorte, il y en a à foison, Elle ouvrira les portes, des palais, des prisons",
      ...
      },
      {
        ...
        difficulty: -20,
        formula: "Les nuages qui occultent les cieux vocifèrent Que le tonnerre exulte, en un terrible éclair !",
        type: ["Air"],
        duration: "instantanée",
        range: "extrême",
        resistance: "MOU",
      ...
      },
      {
        name: "Communion",
        difficulty: 20,
        formula: "Conversons à présent : nos esprits sont liés Par le fil scintillant de nos lointaines pensées",
        type: ["Mentalisme"],
        duration: "RU minutes",
        range: "spécial",
        resistance: "VOL",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Les grands esprits se murent, dans les hautes tours d’ivoire Mais parfois des murmures, divulguent leurs savoirs",
        type: ["Divination"],
        duration: "RU minutes",
        range: "courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Dans les chardons ardents, ils sont nés ; Qu’on acclame ! Les derniers descendants du Feu et de la Flamme",
        type: ["Feu"],
        duration: "une heure",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Elles laissent sur leur sillage, les embruns qui parfument L’air, et les coquillages, de leurs cheveux d’écume",
        type: ["Eau"],
        duration: "une heure",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "J’ai trouvé sous les roches, le Petit Peuple Gris Le voilà qui approche, si loin de son abri",
        type: ["Terre"],
        duration: "une heure",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "A trop semer le vent, j’ai des sylphes pour récolte Ils viennent, je les entends, qui dansent et virevoltent",
        type: ["Air"],
        duration: "une heure",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        alt: "corde enchantee",
        difficulty: 20,
        formula: "Entends ces quelques vers qu’avec joie je t’adresse, Et déjà comme un ver, tu ondules et te dresses",
      ...
      },
      {
        ...
        difficulty: -10,
        formula: "Âme damnée qu’on ne sauve, je suis le monstre abject L’enfant bâtard des fauves, des rapaces, des insectes",
        ...
        resistance: "-",
        success: "Dégâts +1",
        description: "Vous transformez le corps de la cible consentante en un hybride monstrueux qui lui procure des capacités uniques. Vous pouvez choisir MAG options parmi celles-ci (les ailes comptent double) : Ecailles, fourrures: protection de 2. Griffes, mandibules, crocs: dégâts FOR-1. Venin: VIR de +10, dégâts de 2/tour. Ailes d’oiseau ou d’insecte: possibilité de voler. Branchies: possibilité de respirer sous l’eau. Yeux de chat: vision nocturne. Aspect terrifiant: la cible gagne PEUR (1)."
      },
      {
        name: "Course du vent",
        difficulty: 0,
        formula: "Courrons à vive allure : que nos jambes soient légères ! Sur le sol, sur les murs, comme portés par les airs !",
        type: ["Air", "Voyage"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Le sentier que j’emprunte, vénérable secret, Ne laisse aucune empreinte, dans les bois et forêts",
        type: ["Terre"],
        duration: "une heure",
        range: "Contact",
        resistance: "-",
        success: "Bulle",
        description: "La cible peut, au choix du mage : doubler sa vitesse de déplacement en forêt, sans laisser la moindre trace sur le sol. entrer dans un arbre pour ressortir par un autre de la même forêt situé à MAG kilomètres au maximum."
      },
      {
        name: "Crânes enchantés",
        alt: "cranes enchantés",
        difficulty: 0,
        formula: "Vous êtes à mes côtés, mes amis les plus chers, Pauvres décapités, qui étiez-vous naguère ?",
        type: ["Nécromancie"],
        duration: "une heure",
        range: "Courte",
        resistance: "MOU",
        success: "Durée x2 ou Dégâts +1",
        description: "Vous enchantez (RU) crânes humanoïdes autour de vous. Chaque crâne peut être soit : un crâne enflammé, qui file sur une cible et explose causant MAG+1 dégâts de feu. Vous ne pouvez projeter qu’un crâne par tour. un crâne bavard qui délivre un court message à celui qui le touche. un crâne guetteur, qui crie et claque des dents si un intrus entre dans son « champ de vision ». Si aucun crâne n’est à proximité, vous pouvez en invoquer un seul doté d’une des propriétés ci-dessus."
      },
      {
        name: "Croisade",
        difficulty: -20,
        formula: "Oyez frères et amis, les cris et les prières Haro sur l’ennemi qui rampe à nos frontières !",
      ...
      },
      {
        name: "Danse macabre",
        difficulty: -10,
        formula: "Comme une dernière offrande aux âmes des trépassés Dansez la sarabande, jusqu’à vous effondrer",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Évitons cet endroit, où le moindre faux-pas Mène les maladroits, de la vie au trépas",
        type: ["Illusions"],
        duration: "MAG tours",
        range: "Contact",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: -20,
        formula: "Crains le courroux du ciel, et cours trouver refuge Tombez pluies torrentielles, déchaînez le Déluge !",
        type: ["Eau"],
        special: "Rituel",
        duration: "RU jours",
        range: "Extrême",
      ...
      },
      {
        name: "Démence",
        difficulty: -10,
        formula: "Dans la ruine, la débâcle, ils se mettent à genoux Comme un triste spectacle, dans le Pays des Fous",
        type: ["Mentalisme"],
        duration: "MAG tours",
        range: "Courte",
        resistance: "VOL",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Ce dernier chant funèbre, demeure un chant d’amour Et garde des ténèbres, ton voyage sans-retour",
      ...
      },
      {
        name: "Discernement",
        difficulty: 10,
        formula: "Les charmes et maléfices ne font plus illusion J’ai saisi l’artifice d’où vient la confusion",
      ...
      },
      {
        name: "Disparition",
        difficulty: -10,
        formula: "Nuages et fumées blanches se présentent, quelle aubaine ! Pour descendre des planches, disparaître de scène",
        type: ["Illusions"],
        duration: "instantanée",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        name: "Dissimulation",
        difficulty: 10,
        formula: "Mille couleurs, mille reflets, ont recouvert mon corps Pour un portrait parfait de la toile du décor",
        type: ["Ombre", "Voyage"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        name: "Domination",
        difficulty: 0,
        formula: "Obéis à ton maître : tout ira pour le mieux, Ne laisse rien paraître, dans tes gestes ou tes yeux",
      ...
      },
      {
        name: "Don divin",
        difficulty: 20,
        formula: "J’ai chanté tes louanges à la lumière du ciel, Pour que là-haut les anges, t’offrent l’or et le miel",
        type: ["Protection"],
        duration: "RU heures",
        range: "Longue",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: -30,
        formula: "Il surgit du néant, et sillonne le monde Le Dragon-Océan est en chasse et il gronde",
        type: ["Eau"],
        special: "Rituel",
        duration: "RU heures",
        range: "Extrême",
        resistance: "-",
        success: "Dégâts +1",
        description: "Vous invoquez le Dragon des Abysses, un gigantesque monstre d’eau. Il ne peut apparaître que dans une grande étendue d’eau (lac, fleuve, mer, océan…). Il peut combattre à vos côtés, et vous avaler pour vous faire voyager sous l’eau, ainsi que (MAG) alliés. Il vous recrachera ensuite à la surface. Vous ne pouvez l’invoquer plus d’une fois par semaine."
      },
      {
        name: "Duplication",
        difficulty: -10,
        formula: "Quand d’une main de maître, on façonne, on duplique, Nul ne peut reconnaître, le faux de l’authentique",
      ...
      },
      {
        name: "Eau de roche",
        difficulty: 20,
        formula: "Comme le disaient les sages à la gorge trop sèche -Point de meilleur breuvage, que cette eau pure et fraîche !",
        type: ["Eau"],
        duration: "instantanée",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        name: "Effondrement",
        difficulty: 0,
        formula: "Tel le pas d’un géant creuse le sol et la pierre, Laisse un gouffre béant dans un bruit de tonnerre !",
        type: ["Guerre", "Terre"],
        duration: "instantanée",
        range: "Courte",
        resistance: "MOU",
      ...
      },
      {
        ...
        alt: "egide",
        difficulty: 0,
        formula: "Nul ne l’a vaincu, le chevalier sans peur Il portait cet écu et servait mes couleurs",
        type: ["Guerre"],
        duration: "RU minutes",
        range: "Longue",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: -30,
        formula: "L’élixir de cette flasque renversera le temps J’ai modelé vos masques dans le sang des enfants",
        type: ["Alchimie"],
        special: "Rituel",
        duration: "instantanée",
        range: "Contact",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Buvez donc ces liqueurs, pour la fertilité, Retrouver sa vigueur, ou sa virginité",
        type: ["Alchimie"],
        special: "Rituel",
        duration: "instantanée",
        range: "Contact",
        resistance: "-",
        success: "Deux élixirs sont créés",
        description: "Un liquide quelconque devient un élixir aux propriétés à choisir parmi ces trois effets : vaincre la stérilité ou devenir plus fécond, vigueur et plaisir pendant l’acte sexuel, ou retrouver sa virginité."
      },
      {
        name: "Enfant du Verseau",
        difficulty: -10,
        formula: "Né de chair et de sang, je ne suis plus que l’eau, Libre et fort : le torrent de l’amphore du Verseau",
        type: ["Eau"],
        duration: "RU+1 tours",
        range: "Contact",
        resistance: "-",
      ...
      },
      {
        name: "Envol",
        difficulty: -20,
        formula: "Je prendrai mon élan à la fin de ces vers Pour chevaucher le vent et ne plus toucher terre",
        type: ["Air", "Voyage"],
        duration: "RU heures",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Quand le combat fait rage dans les cris et les flammes, Ne perds jamais courage et cherche l’oriflamme",
      ...
      },
      {
        name: "Exorcisme",
        difficulty: 0,
        formula: "Ô puissante cantique, tu triomphes des démons Des paroles hérétiques et des sombres visions",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Sous le poids d’un fardeau, sur la voie du calvaire Tu courberas le dos, mettras genou à terre",
        type: ["Air", "Châtiment"],
        duration: "MAG tours",
        range: "Moyenne",
        resistance: "FOR",
      ...
      },
      {
        ...
        difficulty: 20,
        formula: "Le vent m’a chuchoté : « Si l’infortuné tombe Il sera plus léger que la plume d’une colombe »",
        type: ["Air"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        ...
        alt: "fleche ardente",
        difficulty: 0,
        formula: "Je t’invoque flèche ardente, trait de feu sanguinaire, Que tes flammes dévorantes se nourrissent de la chair !",
        type: ["Feu", "Guerre"],
        duration: "instantanée",
        range: "Extrême",
        resistance: "MOU",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "La flèche ensorcelée vole droit vers le coeur Du gibier désigné du terrible chasseur",
        type:  ["Enchantements"],
        duration: "instantanée",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        name: "Fleur de feu",
        difficulty: -20,
        formula: "Graine de feu, fleur carmin ne demande qu’à éclore Comme elle brille dans mes mains, brûle de plus en plus fort !",
        type: ["Feu", "Guerre"],
        duration: "instantanée",
        range: "Longue",
        resistance: "MOU",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Sur ma peau, ma figure, doucement immergées, Se ferment les blessures qu’ils m’ont tous infligés",
      ...
      },
      {
        ...
        difficulty: 20,
        formula: "Ephémère est la chose, qu’une pincée de poudre Qu’on étale, qu’on dépose, suffira à dissoudre",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Nous parcourons la lande, dans la nuit, dans le froid Et partageons la viande encore chaude de nos proies",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Le frère d’armes que j’invoque, virevolte à mes côtés, Frappe de taille et d’estoc sans jamais reculer",
        type: ["Enchantements", "Guerre"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        name: "Fumée sombre",
        difficulty: 10,
        formula: "Subterfuge démoniaque jaillissant des crevasses Fumées noires et opaques, nous entourent, nous enlacent",
      ...
      },
      {
        ...
        alt: "gangrene",
        difficulty: 0,
        formula: "Quand la gangrène torture, comme sur la plaie le sel La plus petite morsure, peut s’avérer mortelle",
      ...
      },
      {
        name: "Gigantisme",
        difficulty: -10,
        formula: "Nous redoutions leur force, leur folie destructrice Ils avaient sur le torse, mille-et-une cicatrices",
        type: ["Alchimie", "Terre"],
        duration: "RU+1 tours",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: -20,
        formula: "Retrouvez à présent la taille de vos ancêtres Pour qu’en vous lentement, ils puissent enfin renaître",
        type: ["Animalisme"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
      ...
      },
      {
        name: "Golem",
        difficulty: -10,
        formula: "Nuit et jour j’ai créé, façonné de mes mains, Ce serviteur dévoué, qui s’éveille, presqu’humain",
        type: ["Nécromancie", "Alchimie"],
        special: "Rituel",
        duration: "permanente",
        range: "Contact",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "En fouillant le dédale du fond de ton esprit, Je trouverai le mal qui t’a tant affaibli",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Toi qui souffres et qui cries, je guérirai tes maux Et les jours assombris brilleront à nouveau",
      ...
      },
      {
        ...
        difficulty: -10,
        formula: "La vieille dame des charniers m’a confié son trésor, De mes doigts décharnés pendent les griffes de la Mort",
        type: ["Nécromancie"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: -10,
        formula: "J’en appelle au champion de Fantasmagorie Ce fidèle compagnon ne m’a jamais trahi",
        type: ["Illusions"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
        success: "Dégâts +1",
        description: "Un guerrier illusoire - dont vous décidez de l’apparence - apparaît et affronte vos ennemis. Ceux-ci doivent réussir un test de VOL à chaque tour pour ne pas subir ses coups, sans quoi les attaques qu’il porte sont bien réelles. Ses valeurs sont les suivantes : COM 60/-10 Init : 15 Prot : 5 PV : 20 DG : Épée ou hache RU +6 Comp : FOR 60, MOU 70"
      },
      {
        name: "Histoire de l’inconnu",
        alt: "histoire de l'inconnu",
        difficulty: 0,
        formula: "Tout sujet garde en lui mille-et-un souvenirs Les beaux jours et les pluies, les sanglots et les rires",
        type: ["Divination"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 10,
        formula: "Laisse entrer la furie, c’est une folle délivrance C’est un souffle, c’est un cri qui déchire le silence",
        type: ["Animalisme"],
        duration: "instantanée",
        range: "Courte",
        resistance: "VOL",
      ...
      },
      {
        name: "Incandescence",
        difficulty: 0,
        formula: "Nous ferons rendre gorge à l’ennemi arrogant, Notre colère nous forge des armes chauffées à blanc",
        type: ["Feu", "Châtiment"],
        duration: "*MAG* tours",
        range: "Moyenne",
        resistance: "-",
        success: "Dégâts +1",
        description: "Ce sortilège chauffe une pièce de métal jusqu’à la rendre incandescente. Vous pouvez au choix : chauffer une lame qui infligera des dégâts de feu, et ajoutera 2 à ses dégâts ; ou chauffer une pièce métallique (bijou, pièce d’amure…) qui fera se tordre de douleur son porteur qui subira 2 points de dégâts par tour tant qu’il ne l’aura pas retirée."
      },
      {
        name: "Influence insidieuse",
        difficulty: 10,
        formula: "Laissez ces doux murmures approcher vos oreilles Il est toujours plus sûr d’écouter leurs conseils",
        type: ["Mentalisme", "Ombre"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "VOL",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "A la croisée des routes, j’ai suivi mon instinct, Ni la peur ni les doutes, n’entravaient mon destin",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Ne commets point la faute - elle peut être fatale, De marcher tête haute dans l’assemblée bestiale",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "D’un geste, d’une parole, enfilons ce costume, Pour danser la farandole des voyageurs de brume",
        type: ["Illusions", "Ombre"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Elles vivent autour de nous, ces créatures terribles Rejoins à pas-de-loup, le Royaume Invisible",
      ...
      },
      {
        ...
        difficulty: 0,
        formula: "Tu ne cherches ni la gloire, ni l’or, ni le prestige, Bats-toi pour ma victoire, ô valeureux homme-lige",
        type: ["Guerre", "Enchantements"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
        success: "Dégâts +1",
        description: "Vous invoquez un guerrier en armure antique et aux yeux brillants qui agit immédiatement selon vos ordres. Il n’est pas obligé d’attaquer et peut très bien se tenir près de vous, comme un garde du corps. Homme-lige : COM 50/0 Init : 12 Prot : 4 (armure antique) PV : 20 DG : Épée ou Lance RU+5 Comp : FOR 50, MOU 40, PER 50"
      },
      {
        name: "Jugement Dernier",
        difficulty: -30,
        formula: "La fournaise étouffante des mille forges de l’Enfer Offre une mort terrifiante aux âmes noires prisonnières",
        type: ["Protection", "Châtiment"],
        special: "Rituel",
        duration: "instantanée",
        range: "Extrême",
      ...
      },
    {
        ...
        difficulty: 0,
        formula: "Elle veut d’autres victimes, sombre lame assoiffée Le sang de tous ses crimes ne l’a pas rassasiée",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Unis aux premiers âges, les hommes de tous pays, Parlaient le même langage, oublié aujourd’hui",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Ô mes beaux frères sauvages, je comprends vos paroles, De vos cris sous l’orage, au chant du rossignol",
        type: ["Animalisme"],
        duration: "RU heures",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Toute âme est comme un livre au mystérieux langage, Les secrets qu’il délivre, sont enfouis dans ses pages",
    ...
    },
    {
        name: "Linceul noir",
        difficulty: 0,
        formula: "C’est un monde silencieux, sans lumière ni vacarme, C’est un voile sur tes yeux, de ténèbres et de larmes",
    ...
    },
    {
        name: "Lion de braise",
        difficulty: -30,
        formula: "Trop longtemps enfermé, je l’ai laissé s’enfuir, Le fauve est affamé, écoutez-le rugir !",
        type: ["Feu"],
        special: "Rituel",
        duration: "RU heures",
        range: "Courte",
        resistance: "-",
        success: "Dégâts +1",
        description: "Vous invoquez le Lion de Braise, monstre rougeoyant à la crinière enflammée, qui pourra combattre à vos côtés. Vous ne pouvez l’invoquer plus d’une fois par semaine."
    },
    {
        name: "Main de la Justice",
        difficulty: 0,
        formula: "Que l’homme qui a meurtri, subisse le châtiment En payant vie pour vie, oeil pour oeil, dent pour dent",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Tu deviendras l’esclave de cette longue pénitence Prisonnier des entraves de ta propre souffrance",
        type: ["Mentalisme"],
        duration: "RU tours",
        range: "Courte",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Noble bête, mon vassal, je suis ton nouveau Roi ! Ne te montre loyal à nul autre que moi",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Jouons avec le feu, sa fumée ou sa forme, Qu’il éblouisse nos yeux ou bien qu’il se rendorme !",
        type: ["Feu"],
        duration: "1 heure",
        range: "Longue",
        resistance: "MOU",
        success: "Dégâts +1",
        description: "Vous pouvez au choix : créer des effets pyrotechniques spectaculaires à partir d’un feu existant (formes dans la fumée ou le feu, agrandissement d’une flamme, étincelles, petites explosions…). Si le feu touche une cible, elle subira *MAG* dégâts de feu. Éteindre un feu existant : un feu de camp s’éteint en un tour, un brasier en une minute, un grand incendie en une heure."
    },
    {
        name: "Maître du vent",
        alt: "maitre du vent",
        difficulty: 10,
        formula: "Le vent du sud m’écoute, le vent du nord se plie, Le vent d’ouest me redoute, le vent d’est obéit",
        type: ["Air", "Voyage"],
        duration: "*MAG* heures",
        range: "Courte",
        resistance: "FOR",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "De la poupe à la proue, le navire penche et tangue Les vagues et les remous, laissent les malades exsangues",
        type: ["Eau", "Mentalisme"],
        duration: "*MAG* tours",
        range: "Moyenne",
        resistance: "END",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Ton âme seule est intacte, vois comme tu as changé, Sois puni pour tes actes dans ce corps étranger",
        type: ["Animalisme"],
        duration: "RU tours",
        range: "Moyenne",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "J’ai porté ce manteau, qu’il ait ma gratitude ! Des étés les plus chauds aux hivers les plus rudes",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Pieds nus, je suis parti, j’ai longtemps avancé, Même les mers en furie, je les ai traversées",
        type: ["Eau", "Voyage"],
        duration: "RU minutes",
        range: "Longue",
        resistance: "-",
    ...
    },
    {
        name: "Martyr",
        difficulty: 0,
        formula: "Trop de sang a coulé, pardonnez leurs erreurs Que mon corps soit brûlé, pour que cesse leur douleur",
        type: ["Protection"],
        duration: "instantanée",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Même le froid, la misère, n’ont brisé l’harmonie Car nous restons des frères, courageux et unis",
    ...
    },
    {
        name: "Métamorphose",
        difficulty: 0,
        formula: "Pour charmer Dame Nature, mets tes plus beaux atours Écailles, plumes, et fourrures sont de mise à sa cour",
        type: ["Animalisme"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
        success: "Cible +1",
        description: "Vous prenez la forme et les aptitudes physiques (scores, capacités) d’un animal commun. Vous pouvez choisir cet animal selon votre *MAG*."
    },
    {
        name: "Miasmes Putrides de Marrak",
        difficulty: 10,
        formula: "Dans un souffle puissant, que jaillissent les vapeurs Et relents pestilents venus des profondeurs",
        type: ["Nécromancie"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "END",
    ...
    },
    {
        name: "Mille pointes",
        difficulty: 10,
        formula: "Vois ces quelques cailloux embrocher l’adversaire Aux jambes, au ventre, au cou, comme mille pointes de fer",
    ...
    },
    {
        ...
        alt: "monstre d'ombre",
        difficulty: -20,
        formula: "Elles se cachent derrière nous, elles évitent le soleil, Ces silhouettes au-dessous, seule la faim les éveille",
        type: ["Illusions", "Ombre"],
        duration: "*MAG* tours",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Au sortir de l’étable jusqu’au soleil couchant, Tu es infatigable et plus vif que le vent",
        type: ["Guerre"],
    ...
    },
    {
        name: "Mur de feu",
        difficulty: 0,
        formula: "Invincible rempart, gigantesque brasier Par le feu nous sépare du fer et de l’acier",
        type: ["Feu"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        name: "Mur de Pierre",
        difficulty: 10,
        formula: "Pour préserver les nôtres, nous bâtirons ce mur Une pierre après l’autre, qui jamais ne fissure",
        type: ["Terre"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Il n’a ni lance, ni casque, ce soldat aérien, Il est la grande bourrasque qui me sert de gardien",
        type: ["Air"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: -20,
        formula: "Vents de cendre et de soufre s’élèvent en tourbillon, Où peu à peu s’engouffre le souffle des Dragons",
        type: ["Feu"],
        duration: "*MAG* tours",
        range: "Courte",
        resistance: "END",
    ...
    },
    {
        ...
        alt: "oeil du basilic",
        difficulty: -10,
        formula: "Comme l’antique vestige des cités de naguère, C’est le temps qui se fige sur une statue de pierre",
        type: ["Terre"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Par-delà les frontières, à travers les cloisons Quelles que soient les barrières, nous verrons l’horizon",
        type: ["Châtiment", "Divination"],
        duration: "RU tours",
        range: "Extrême",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 20,
        formula: "Quand les Rois nous promirent d’apporter la lumière Ils n’ont fait que trahir, leurs ombres étaient derrière",
        type: ["Illusions", "Ombre"],
        duration: "RU minutes",
        range: "Longue",
        resistance: "-",
    ...
    },
    {
        name: "Or des fous",
        difficulty: 10,
        formula: "Poussière de mensonge, or des fous, poudre aux yeux, Font sortir de mes songes le métal si précieux",
        type: ["Enchantements", "Alchimie"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        name: "Ours de Pierre",
        difficulty: -30,
        formula: "Souviens-toi du gardien des monts et des forêts, Géant des temps anciens, le voilà qui renaît",
        type: ["Terre"],
        special: "Rituel",
        duration: "RU heures",
        range: "Courte",
        ...
        description: "Vous invoquez l’Ours de pierre, colossal monstre minéral aux yeux d’obsidienne, qui peut combattre à vos côtés ou vous transporter vous et vos compagnons. Vous ne pouvez l’invoquer plus d’une fois par semaine."
    },
    {
        name: "Palimpseste",
        difficulty: -20,
        formula: "Les mots doivent disparaître, de ce vieux parchemin Pour que de nouvelles lettres, montrent un autre chemin",
    ...
    },
    {
        ...
        difficulty: 20,
        formula: "Comme l’odeur de la mort ou le parfum des fleurs Quelques vers et un sort troubleront bien des coeurs",
        type: ["Illusions"],
        duration: "RU minutes",
        range: "Longue",
        resistance: "-",
    ...
    },
    {
        ...
        alt: "passe muraille",
        difficulty: 0,
        formula: "Les portes et murailles des grands châteaux de pierre Ont chacune une faille pour passer au travers",
    ...
    },
    {
        ...
        alt: "peau d'ecorce",
        difficulty: 0,
        formula: "Nous avons hérité de l’écorce des vieux chênes, Et au solstice d’été, leur sève coule dans nos veines",
        type: ["Terre"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "J’ai tracé ce symbole pour défendre les miens Et qu’un jour il immole, les curieux, les vauriens",
        type: ["Châtiment", "Feu"],
        duration: "instantanée",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        name: "Pluie acide",
        difficulty: 0,
        formula: "Que le ciel s’assombrisse, et que tombent les gouttes D’une pluie destructrice sur une armée dissoute",
        type: ["Eau", "Guerre"],
        duration: "*MAG* tours",
        range: "Longue",
        resistance: "END",
    ...
    },
    {
        name: "Prescience",
        difficulty: 0,
        formula: "C’est une voix qui m’entraîne, m’inspire et me protège Guide mes pas dans l’arène comme les plus grands stratèges",
        type: ["Divination"],
        duration: "RU +1 tours",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Les montagnes du Nord ont des neiges éternelles J’y ai plongé ton corps dans une prison de gel",
        type: ["Eau"],
        duration: "*MAG* tours",
        range: "Moyenne",
        resistance: "FOR",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Ne plus suivre les ordres, courir sans s’arrêter Hurler, bondir et mordre : goûter la liberté",
        type: ["Animalisme"],
        duration: "RU minutes",
        range: "Courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Les reflets des miroirs attendent ce stratagème, Et brûlent d’enfin pouvoir exister par eux-mêmes",
        type: ["Illusions"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Il ne faudra qu’un geste, une main sur une peau Pour que fièvres et pestes s’évaporent aussitôt",
        type: ["Protection"],
        duration: "instantanée",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Le temps sait te guérir, que repoussent tes branches Je les vois refleurir, ô glorieuse revanche",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Les guerriers silencieux, autour du feu éteint Ont rendu grâce à Dieu et se reposent enfin",
        type: ["Guerre", "Voyage"],
        duration: "instantanée",
        range: "Moyenne",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 20,
        formula: "J’ai reçu ce cadeau de la main des tritons Pour les suivre sous l’eau dans les Pays Profonds",
        type: ["Animalisme", "Eau"],
        duration: "RU heures",
        range: "Longue",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Autour de moi les corps, un à un se réveillent Prêts à se battre encore, jusqu’au dernier sommeil",
        type: ["Nécromancie"],
        duration: "*MAG* heures",
        range: "Moyenne",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "J’ai lu dans ses yeux vides, la paix ou le tourment, Courte vision limpide de ses derniers instants",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Dans les contrées lointaines des rêves évanouis Vivent les diables, les sirènes, du sommeil de minuit",
        type: ["Mentalisme"],
        duration: "RU heures",
        range: "spécial",
        resistance: "VOL",
    ...
    },
    {
        ...
        alt: "roi des betes",
        difficulty: "-10",
        formula: "Que tous les animaux qui ont prêté serment, Rejoignent aussitôt mon cri de ralliement",
        type: ["Animalisme"],
        duration: "une heure",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Reculez face aux ronces, qui s’érigent en barrière Elles s’enroulent et s’enfoncent au plus profond des chairs",
        type: ["Terre"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "MOU",
        success: "Cible +1",
        description: "Des ronces sortent du sol et peuvent au choix : entraver un adversaire qui est Paralysé tant qu’il n’a pas supprimé la ronce gardienne, ou créer une barrière d’épines haute d’1m50 qui vous protégera, et que vos ennemis devront enjamber. Dans tous les cas, elles ont une valeur de COM de 40, 10 PV et infligent des dégâts de *MAG*."
    },
    {
        name: "Salamandre",
        difficulty: 0,
        formula: "Mes haillons sont noircis, mais mon corps reste entier, Au coeur de l’incendie ou sur le grand bûcher",
        type: ["Feu"],
        duration: "RU heures",
        range: "Longue",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Béni soit ce sanctuaire : que ceux qui le franchissent Subissent la colère des flammes de la justice",
        type: ["Protection"],
        duration: "RU minutes",
        range: "Contact",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Elle s’acharne, vengeresse, fait plier les empires, La cruelle sécheresse vous regarde dépérir",
        type: ["Feu", "Eau"],
        duration: "instantanée",
        range: "Moyenne",
        resistance: "END",
        success: "Cible +1",
        description: "Vous pouvez au choix : assécher un lieu sur une zone de (RU) mètres de rayon, ou affaiblir une cible dont la peau se flétrit, et subit (RU+2) dégâts que l’armure n’absorbe pas. Elle est Affaiblie jusqu’à ce qu’elle se réhydrate."
    },
    {
        name: "Soif de Sang",
        difficulty: 0,
        formula: "Donne le goût du sang et l’écume à mes lèvres La rage du survivant, dans une dernière fièvre",
        type: ["Animalisme", "Guerre"],
        duration: "RU+1 tours",
        range: "Contact",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Quand s’éteint le soleil derrière tes yeux si lourds Entre dans un sommeil aux doux draps de velours",
        type: ["Mentalisme", "Ombre"],
        duration: "RU heures",
        range: "Longue",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 20,
        formula: "Coquins et nobles gens le savent tous au dehors : La parole est d’argent mais le silence est d’or",
        type: ["Ombre", "Air", "Illusions"],
        duration: "RU minutes",
        range: "longue",
        resistance: "-",
        success: "Cible +1 ou Zone x2",
        description: "Vous pouvez créer au choix : des bruits, mélodies, voix ou paroles audibles par (MAG) cibles maximum. Les voix peuvent en imiter une autre à la perfection et prononcer un discours que vous aurez choisi. Une zone de silence de (MAG) mètres de rayon est également possible, dans laquelle tout bruit est étouffé."
    },
    {
        name: "Souffle de pureté",
        difficulty: 20,
        formula: "J’ai parcouru le ciel, qu’on m’accueille, triomphal Que l’air pestilentiel disparaisse d’une rafale !",
        type: ["Air"],
        duration: "instantanée",
        range: "courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Il est dit que l’Histoire appartient aux vainqueurs Ils balayent les mémoires, qui dans l’oubli se meurent",
        type: ["Mentalisme"],
        duration: "RU heures",
        range: "courte",
        resistance: "VOL-10",
    ...
    },
    {
        ...
        difficulty: -20,
        formula: "Mon esprit s’arrache de ce corps bien trop lourd Qu’il vole sans attaches jusqu’au lever du jour",
        type: ["Nécromancie"],
        special: "Rituel",
        duration: "RU heures",
        range: "contact",
    ...
    },
    {
        name: "Spiritisme",
        difficulty: 0,
        formula: "Pour qu’on me prête mainforte dans les heures les plus sombres J’ai frappé à la porte du royaume des ombres",
        type: ["Nécromancie"],
        special: "Rituel",
        duration: "RU minutes",
        range: "contact",
    ...
    },
    {
        name: "Suffocation",
        difficulty: 0,
        formula: "Comme le chien qu’on punit en tirant sur sa sangle C’est ton air qui s’enfuit, c’est ta gorge qu’on étrangle",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "L’imprudent qui veut suivre, ces chemins recouverts Par la neige et le givre, devra vaincre l’Hiver",
        type: ["Eau"],
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "A l’heure de comparaître à l’épreuve du bûcher Les félons et les traîtres seront tous démasqués",
    ...
    },
    {
        ...
        difficulty: 20,
        formula: "En un claquement de doigts, qu’une flamme apparaisse ! Qu’elle crépite et flamboie comme dans les nuits d’ivresse",
        type: ["Feu", "Voyage"],
        duration: "RU heures",
        range: "courte",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Mes légions souterraines abattront à l’instant Pour les Rois et les Reines un travail de titan",
        type: ["Terre"],
        special: "Rituel",
        duration: "RU jours",
        range: "longue",
    ...
    },
    {
        name: "Transmutation",
        difficulty: 10,
        formula: "Roche, métal ou bien bois, sont issus du même sang On les confond parfois, tant la terre a d’enfants",
        type: ["Terre", "Alchimie"],
        duration: "RU minutes",
        range: "Moyenne",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Les condamnés marqués du symbole de la honte Ne pourront échapper à la loi des Archontes",
        type: ["Châtiment", "Divination"],
        duration: "RU jours",
        range: "Extrême",
        resistance: "-",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Dépourvus de sagesse, les pécheurs veulent encore Les plus somptueuses richesses qui pourtant s’évaporent",
        type: ["Illusions"],
        duration: "RU minutes",
        range: "Longue",
        resistance: "PER",
    ...
    },
    {
        ...
        difficulty: 0,
        formula: "Que le souffle d’azur, émeraude, écarlate, Se répande en brûlures et douloureux stigmates",
    ...
    },
    {
        name: "Venin noir",
        difficulty: 0,
        formula: "Que les crocs du serpent, et le dard du scorpion, Soient les deux artisans de ce sombre poison",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Voyez la pierre se fendre et les arbres s’ouvrir Cachons-nous sans attendre pour échapper au pire",
        type: ["Terre", "Voyage"],
        duration: "RU jours",
        range: "Moyenne",
        resistance: "-",
    ...
    {
        name: "Visions cauchemardesques de Shaula",
        difficulty: 10,
        formula: "J’ai exhumé la peur, dans tes rêves, tes nuits noires Pour qu’au fond de ton cœur se creuse le désespoir",
        type: ["Mentalisme", "Nécromancie"],
        duration: "*MAG* tours",
        range: "Courte",
        resistance: "VOL",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "On discerne les âmes, qui est lion, qui est rat, A l’ardeur de leur flamme, à la teinte et l’éclat",
    ...
    },
    {
        ...
        difficulty: -10,
        formula: "Un millier de plumes noires ornaient mes oripeaux J’ai puisé mon pouvoir dans le vol des corbeaux",
    ...
    },
    {
        ...
        difficulty: 10,
        formula: "Chaussez vos meilleures bottes, aiguisez votre épée Car partout on chuchote, que l’heure est arrivée",
        type: ["Voyage"],
        duration: "RU jours",
        range: "Contact",
        resistance: "-",
